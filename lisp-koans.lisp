...
(defpackage #:net.common-lisp.lisp-koans
  (:use #:common-lisp
        #:net.common-lisp.lisp-koans.test)
  (:export #:main))

(in-package #:net.common-lisp.lisp-koans)
...
(defun package-name-from-group-name (group-name)
  (format nil "NET.COMMON-LISP.LISP-KOANS.KOANS.~A" group-name))
  ...
  (let* ((koan-name (string-downcase (string koan-group-name)))
    ...
    (unless (find-package koan-package-name)
      (make-package koan-package-name
                    :use '(#:common-lisp #:net.common-lisp.lisp-koans.test)))
